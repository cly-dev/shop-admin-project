...
import ExpandRander from "../ReturnExpandRander/index.vue";
import "./index.scss";
const ProductColumn: TableType.ColumnType[] = [
  ...
  },
  {
    ...
    template: (data: any) => {
      ...
      return <>
      {/* TODO: 根据订单状态设置按钮 */}
        <el-button onClick={handleEdit}>同意</el-button>
        <el-button type="danger" onClick={() => handleClick(data)}>拒绝</el-button>
      </>
    },
  },
]
